    ...
    return (
            <div className="col-xl-12 d-flex justify-content-center">
                <Form id="form-register-project" className="col-xl-4">
                    <h1>Criar Projeto</h1>
                    <p className="fs-5 fw-800 text-muted">Crie seu projeto para depois adicionar os serviços</p>
                    <Form.Group className="mb-2">
                        <Form.Label>Nome do projeto:</Form.Label>
                        <Form.Control value={name} onChange={(event) => setName(event.target.value) } placeholder="Insira o nome do projeto" />
                    </Form.Group>
                    <Form.Group className="mb-2">
                        <Form.Label>Orçamento do projeto:</Form.Label>
                        <Form.Control type="number" value={budget} onChange={(event) => setBudget(event.target.value)} placeholder="Insira o orçamento do projeto" />
                    </Form.Group>
                    <Form.Group className="mb-2">
